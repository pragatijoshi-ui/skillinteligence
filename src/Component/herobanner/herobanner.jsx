...
const Herobanner = () => {        
    return (
        <>
        <section className='mb-md-78 mb-28 section-herobanner'>
            <div className='Herobanner-main-div section-larg-padding-T-B position-relative'>
                <div className='container'>
                    <div className='row align-items-center justify-content-center'>
                        <div className='col-12 col-md-7'>
                            <p data-aos="fade-up" data-aos-duration="3000" className='text-black font-md-20 font-12 be-vietnam-pro-regular'>Welcome To</p>
                            ...
                            <p data-aos="fade-up" data-aos-duration="1000" className='font-md-20 font-12 be-vietnam-pro-regular text-black w-80'>Our company operates in the education and professional development sector, focusing on delivering high-quality training programs</p>
                        </div>
                        <div className='col-12 col-md-5'>
                            <div className='d-flex justify-content-end position-relative align-items-end'>
